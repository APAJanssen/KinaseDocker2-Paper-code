'''
This script is used to dock compounds using DiffDock.

NOTE: Currently this script requires that the argument --protein_ligand_csv is used.
'''
import copy
import os
import torch
...
from utils.diffdock_utils import InferenceDataset, set_nones, preprocess_data, postprocess_data
...
if args.protein_ligand_csv is not None:
    klifs_chunks = preprocess_data(args.protein_ligand_csv) # Table with columns: complex_name, protein_path (PATH to .pdb file), ligand_description (SMILES), protein_sequence (can be empty)
